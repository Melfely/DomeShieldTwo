...
{
    public class DomeShieldNodeSet : GovernedSetManager<DomeShieldNode, DomeShieldFeeler, DomeShieldConnectedTypeInfo, AdvShieldProjector>
    {
        ...
        public override DomeShieldNode MakeNode(AllConstruct construct, AdvShieldProjector block)
        {

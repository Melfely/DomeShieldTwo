...
{
    public class DomeShieldCapacitorEnergyData : DataPackage
    {
        public DomeShieldCapacitorEnergyData(uint uniqueId)
        : base(uniqueId)
        {
        }
        ...
        {
            bool flag = this.DSPL != null;
            if (flag)
            {
                this.DSCavity0.Us = this.DSPL.dSBeamInfo[0].Energy;
                this.DSCavity1.Us = this.DSPL.dSBeamInfo[1].Energy;
                this.DSCavity2.Us = this.DSPL.dSBeamInfo[2].Energy;
                this.DSCavity3.Us = this.DSPL.dSBeamInfo[3].Energy;
                this.DSCavity4.Us = this.DSPL.dSBeamInfo[4].Energy;
                this.DSCavity5.Us = this.DSPL.dSBeamInfo[5].Energy;
            }
            base.Save(s, criteria);
        }

        public DomeShieldPowerLink DSPL;
    }
}
*/

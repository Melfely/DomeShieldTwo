...
{
    public class DomeShieldActiveRectifier : DomeShieldCavityLinePiece
    {
        ...
        {
            return DomeShieldActiveRectifier._locFile.Get("Return_Connect", "Connect to dome shield couplers, dome shield cavities, or dome shield modifiers.", true);
        }

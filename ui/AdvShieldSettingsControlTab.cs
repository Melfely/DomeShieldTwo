        ...
        */
        public override void Build()
        {
            ...
            */
            ...
            standardSegment1.AddInterpretter(SubjectiveDisplay<AdvShieldProjector>.Quick(_focus, M.m<AdvShieldProjector>(I => string.Format("Currently, {0}% of the energy is being used for health. {1}% is being routed to the armour class, and {2}% is being used for regeneration", 100 - I.ShieldStats.EnergyPercentForArmour - I.ShieldStats.ActualRegenPercent, I.ShieldStats.EnergyPercentForArmour, I.ShieldStats.ActualRegenPercent))));
            ...
            {
                if (_focus.ShieldStats.EnergyPercentForArmour + _focus.SettingsData.RegenPercent > 90) return "<color=yellow> You cannot divert more than 90% of the shield's energy. Please lower AC if you wish to increase Regen. </color>";
                else return "";
            }))));
            //if (_focus.ShieldStats.EnergyPercentForArmour + _focus.SettingsData.RegenPercent > 90) standardSegment1.AddInterpretter(SubjectiveDisplay<AdvShieldProjector>.Quick(_focus, M.m<AdvShieldProjector>(I => string.Format("<color=yellow> You cannot divert more than 90% of the shield's energy. Please lower AC if you wish to increase Regen. </color>"))));
